...
// App dialogs (the 'modal-launcher' slot and apis.dialog.open) are NOT in
// this table: they share the host's AppDialogShell, which keeps the backdrop
// inert but closes on Escape — the policy's one documented exception. Their
// dismissal is covered in remote-app-load.spec.ts.
