...
describe('exportApplicationState', () => {
  ...
  it('produces parseable JSON with metadata, database and stores sections', async () => {
  ...
  it('never includes auth tokens from the credential store (regression: R2-11)', async () => {
