...
export const BugReportMenuItem = ({
  ...
  return (
    <>
      <MenuItem onClick={handleOpen}>Report a Bug</MenuItem>
      <Dialog open={open} onClose={handleDialogClose} maxWidth="md" fullWidth>
        ...
        <DialogContent>
          ...
          <Typography variant="body1" gutterBottom>
            <b>1)</b> How to reproduce the bug.
          </Typography>
          <Typography variant="body1" gutterBottom>
            <b>2)</b> What operating system you're using.
          </Typography>
          <Typography variant="body1" gutterBottom>
            <b>3)</b> What Cytoscape Web version you're using.
          </Typography>
          <Typography variant="body1" gutterBottom>
            <b>4)</b> What browser you're using.
          </Typography>
          <Alert severity="info" sx={{ mt: 2 , mb:2 }}>
            Try to reproduce the bug yourself <b>before</b> you report it. Be
            sure to include any data we may need to reproduce the bug.
          </Alert>
