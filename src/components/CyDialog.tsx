 ...
 * hard requirement: **every dialog must offer a visible Cancel or Close
 * control**, because nothing else will get the user out.
 *
 ...
 * handler belongs on a button instead.
 *
 ...
 */
export type CyDialogProps = Omit<DialogProps, 'onClose'>
...
export const CyDialog = (props: CyDialogProps): JSX.Element => {
  ...
  return (
    <Dialog
      {...dialogProps}
      // After the spread on purpose: the policy wins over anything a call site
      // passes through.
      onClose={undefined}
