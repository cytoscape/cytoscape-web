...
/**
 * Generate a random color from a predefined list of colors
 */
...
/**
 * Pick evenly distributed colors from a base palette
 *
 * @param base - The base palette to pick from
 * @param count - Number of colors to pick
 * @returns Array of evenly distributed colors
 */
