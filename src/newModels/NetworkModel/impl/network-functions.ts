...
// import TableFn, { Table, Column } from '../../TableModel'
...
//     table: TableFn.createTable(id),
//   } as Network & GraphStore<Core> & PropertyGraph)
...
//   const table: Table = TableFn.createTable(id || 'table')
