 ...
 *
 * @deprecated Superseded by the domain-grouped code catalogs below
 * (`ElementCodes`, `TableCodes`, `StyleCodes`, `AppCodes`). Retained
 * temporarily during the migration in `src/app-api/core/`; will be
 * removed once no call site references it.
 */
