...
describe('Test type coercion during network merge', () => {
  it('should perform the type coercion correctly (1/2)', () => {
    ...
    nodeTableRows1.set(nodeLst1[0], {
      ...
      lst_int: [1, 2],
      lst_double: [1.1, 2.2],
      lst_bool: [true, false, true],
    })
    nodeTableRows1.set(nodeLst1[1], {
      name: 'node 2',
      sin_str: 2,
      sin_bool: false,
      sin_int: 2,
    ...
    nodeTableRows2.set(nodeLst2[0], {
      ...
      lst_int: [5, 6],
      lst_double: [5.5, 6.6],
      lst_bool: [true, false, false],
    })
    nodeTableRows2.set(nodeLst2[1], {
      name: 'node 2',
      sin_str: 4,
      sin_bool: false,
      sin_int: 4,
    ...
    const nodeTable1 = {
      ...
      columns: [
        ...
        { name: 'sin_str', type: 'string' },
        { name: 'sin_bool', type: 'boolean' },
        { name: 'sin_int', type: 'integer' },
        { name: 'sin_double', type: 'double' },
        { name: 'lst_str', type: 'list_of_string' },
        { name: 'lst_int', type: 'list_of_integer' },
        { name: 'lst_double', type: 'list_of_double' },
    ...
    mergedNodeTableRows.set(mergedNodeLst[0], {
      name: 'node 1',
      matchingAtt: 'node 1',
      sin_str: 'true',
      lst_str1: ['1', '2', 'true', 'false'],
      lst_str2: ['a', 'b', '5.5', '6.6'],
      lst_double: [1, 3.3],
      lst_bool: [true, false],
    })
    mergedNodeTableRows.set(mergedNodeLst[1], {
      name: 'node 2',
      matchingAtt: 'node 2',
      sin_str: 'false',
      lst_double: [2, 4.4],
    })
    mergedNodeTableRows.set(mergedNodeLst[2], {
      name: 'node 3',
      matchingAtt: 'node 3',
      lst_str1: ['3', '4', 'false', 'true'],
      lst_str2: ['c', 'd', '7.7', '8.8'],
      lst_bool: [false, true],
    })
    ...
    const mergedNodeTable = {
      id: toNetworkId,
      columns: [
        { name: 'matchingAtt', type: 'string' },
        { name: 'name', type: 'string' },
        { name: 'sin_str', type: 'string' },
        { name: 'lst_str1', type: 'list_of_string' },
        { name: 'lst_str2', type: 'list_of_string' },
        { name: 'lst_double', type: 'list_of_double' },
        { name: 'lst_bool', type: 'list_of_boolean' },
      ],
    ...
    const nodeAttributeMapping = createMatchingTable([
      ...
      {
        id: 2,
        mergedNetwork: 'sin_str',
        type: 'string',
        hasConflicts: false,
        typeRecord: {
          [fromNetworks[0]]: 'boolean',
          [fromNetworks[1]]: 'string',
        },
        nameRecord: {
          [fromNetworks[0]]: 'sin_bool',
          [fromNetworks[1]]: 'sin_str',
        },
      },
      {
        id: 3,
        mergedNetwork: 'lst_str1',
        type: 'list_of_string',
        hasConflicts: false,
        typeRecord: {
          [fromNetworks[0]]: 'list_of_integer',
          [fromNetworks[1]]: 'list_of_boolean',
        },
        nameRecord: {
          [fromNetworks[0]]: 'lst_int',
          [fromNetworks[1]]: 'lst_bool',
        },
      },
      {
        id: 4,
        mergedNetwork: 'lst_str2',
        type: 'list_of_string',
        hasConflicts: false,
        typeRecord: {
          [fromNetworks[0]]: 'list_of_string',
          [fromNetworks[1]]: 'list_of_double',
        },
        nameRecord: {
          [fromNetworks[0]]: 'lst_str',
          [fromNetworks[1]]: 'lst_double',
        },
      },
      {
        id: 5,
        mergedNetwork: 'lst_double',
        type: 'list_of_double',
        hasConflicts: false,
        typeRecord: {
          [fromNetworks[0]]: 'integer',
          [fromNetworks[1]]: 'double',
        },
        nameRecord: {
          [fromNetworks[0]]: 'sin_int',
          [fromNetworks[1]]: 'sin_double',
        },
      },
      {
        id: 6,
        mergedNetwork: 'lst_bool',
        type: 'list_of_boolean',
        hasConflicts: false,
        typeRecord: {
          [fromNetworks[0]]: 'list_of_boolean',
          [fromNetworks[1]]: 'list_of_boolean',
        },
        nameRecord: {
          [fromNetworks[0]]: 'lst_bool',
          [fromNetworks[1]]: 'lst_bool',
        },
      },
    ] as MatchingTableRow[])
