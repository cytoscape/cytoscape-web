...
beforeEach(() => {
  vi.resetAllMocks()
  ;(NetworkFn.createNetwork as import('vitest').Mock).mockImplementation(
    (id: IdType) => ({
      id,
      nodes: [],
      edges: [],
  ...
  ;(NetworkFn.addNodes as import('vitest').Mock).mockImplementation(
    (network: Network, nodeIds: IdType[]) => {
      nodeIds.forEach((nodeId) => network.nodes.push({ id: nodeId }))
      return network
    },
  )
  ;(NetworkFn.addNode as import('vitest').Mock).mockImplementation(
    (network: Network, nodeId: IdType) => {
      network.nodes.push({ id: nodeId })
      return network
    },
  )
  ;(NetworkFn.addEdges as import('vitest').Mock).mockImplementation(
    (network: Network, edges: Edge[]) => {
      edges.forEach((edge) => network.edges.push(edge))
      return network
    },
  )
  ;(NetworkFn.addEdge as import('vitest').Mock).mockImplementation(
    (network: Network, edge: Edge) => {
      network.edges.push(edge)
      return network
    },
  )
  ;(
    NetworkFn.createNetworkFromLists as import('vitest').Mock
  ).mockImplementation((id: IdType, nodes: Node[], edges: Edge[]) => {
...
describe('mergeNetwork', () => {
  it('should merge the network nodes and edges successfully', () => {
    ...
    const net1: Network = NetworkFn.createNetworkFromLists(
      fromNetworks[0],
      nodeLst1,
      edgeLst1,
    )
    const net2: Network = NetworkFn.createNetworkFromLists(
      fromNetworks[1],
      nodeLst2,
      edgeLst2,
    )
    const net3: Network = NetworkFn.createNetworkFromLists(
      fromNetworks[2],
      nodeLst3,
      edgeLst3,
    )
    const mergedNetwork: Network = NetworkFn.createNetworkFromLists(
      toNetworkId,
      mergedNodeLst,
      mergedEdgeLst,
    )
    ...
    nodeTableRows3.set(nodeLst3[0].id, {
      name: 'node 7',
      att1: 2,
      att2: '4',
      att3: 'q',
    })
    nodeTableRows3.set(nodeLst3[1].id, {
      name: 'node 8',
      att1: 3,
      att2: '2',
      att3: 'e',
    })
    nodeTableRows3.set(nodeLst3[2].id, {
      name: 'node 9',
      att1: 4,
      att2: '1',
      att3: 'f',
    })
    nodeTableRows3.set(nodeLst3[3].id, {
      name: 'node 10',
      att1: 5,
      att2: '3',
      att3: 'g',
    ...
    nodeTableRows3.set(nodeLst3[5].id, {
      name: 'node 11',
      att1: 1,
      att2: '4',
      att3: 'q',
    ...
    mergedNodeTableRows.set(mergedNodeLst[0].id, {
      name: 'node 1',
      matchingAtt: 1,
      att1_merged: 1,
      att22: 'd',
    ...
    mergedNodeTableRows.set(mergedNodeLst[1].id, {
      name: 'node 2',
      matchingAtt: 2,
      att1_merged: 2,
      att22: 'c',
    ...
    mergedNodeTableRows.set(mergedNodeLst[2].id, {
      name: 'node 3',
      matchingAtt: 3,
      att1_merged: 3,
      att22: 'b',
    ...
    mergedNodeTableRows.set(mergedNodeLst[3].id, {
      name: 'node 4',
      matchingAtt: 4,
      att1_merged: 4,
      att22: 'a',
    ...
    mergedNodeTableRows.set(mergedNodeLst[4].id, {
      name: 'node 8',
      matchingAtt: '',
      att333: 'h',
    })
    mergedNodeTableRows.set(mergedNodeLst[5].id, {
      name: 'node 10',
      matchingAtt: 5,
      att1_merged: 5,
      att22: '3',
    ...
    mergedNodeTableRows.set(mergedNodeLst[6].id, {
      name: 'node 8',
      matchingAtt: '',
      att22: 'h',
    })
    ...
    edgeTableRows2.set(edgeLst2[0].id, {
      name: 'edge 4',
      interaction: 'b',
      att1: 2,
    })
    edgeTableRows2.set(edgeLst2[1].id, {
      name: 'edge 5',
      interaction: 'a',
      att1: 3,
    })
    edgeTableRows2.set(edgeLst2[2].id, { name: 'edge 6', att1: 4 })
    edgeTableRows2.set(edgeLst2[3].id, {
      name: 'edge 7',
      interaction: 'a',
      att1: 5,
    })
    ...
    edgeTableRows3.set(edgeLst3[1].id, {
      name: 'edge 9',
      interaction: 'a',
      att2: 2.33,
    })
    edgeTableRows3.set(edgeLst3[2].id, {
      name: 'edge 10',
      interaction: 'a',
      att2: 3.33,
    })
    edgeTableRows3.set(edgeLst3[3].id, {
      name: 'edge 11',
      interaction: 'a',
      att2: 4.33,
    })
    edgeTableRows3.set(edgeLst3[4].id, {
      name: 'edge 12',
      interaction: 'c',
      att2: 5.33,
    })
    ...
    mergedEdgeTableRows.set(mergedEdgeLst[0].id, {
      name: 'edge 1',
      interaction: 'a',
      att: 3,
    })
    mergedEdgeTableRows.set(mergedEdgeLst[1].id, {
      name: 'edge 2',
      interaction: 'a',
    })
    mergedEdgeTableRows.set(mergedEdgeLst[2].id, {
      name: 'edge 3',
      interaction: 'a',
    })
    mergedEdgeTableRows.set(mergedEdgeLst[3].id, {
      name: 'edge 4',
      interaction: 'b',
      att: 2,
    })
    mergedEdgeTableRows.set(mergedEdgeLst[4].id, {
      name: 'edge 6',
      att: 4,
      att23: 1.33,
    })
    mergedEdgeTableRows.set(mergedEdgeLst[5].id, {
      name: 'edge 7',
      interaction: 'a',
      att: 5,
    })
    mergedEdgeTableRows.set(mergedEdgeLst[6].id, {
      name: 'edge 9',
      interaction: 'a',
      att23: 2.33,
    })
    mergedEdgeTableRows.set(mergedEdgeLst[7].id, {
      name: 'edge 10',
      interaction: 'a',
      att23: 3.33,
    })
    mergedEdgeTableRows.set(mergedEdgeLst[8].id, {
      name: 'edge 11',
      interaction: 'a',
      att23: 4.33,
    })
    mergedEdgeTableRows.set(mergedEdgeLst[9].id, {
      name: 'edge 12',
      interaction: 'c',
      att23: 5.33,
    })
    ...
    const nodeTable1 = {
      ...
      columns: [
        ...
        { name: 'att1', type: 'integer' },
        { name: 'att2', type: 'string' },
      ],
      rows: nodeTableRows1,
    }
    ...
    const mergedNodeTable = {
      id: toNetworkId,
      columns: [
        { name: 'matchingAtt', type: 'integer' },
        { name: 'name', type: 'string' },
        { name: 'att1_merged', type: 'integer' },
        { name: 'att22', type: 'string' },
        { name: 'att333', type: 'string' },
      ],
    ...
    const mergedEdgeTable = {
      ...
      columns: [
        { name: 'name', type: 'string' },
        { name: 'interaction', type: 'string' },
        { name: 'att', type: 'integer' },
        { name: 'att23', type: 'double' },
      ],
    ...
    const nodeAttributeMapping = createMatchingTable([
      {
        id: 0,
        mergedNetwork: 'matchingAtt',
        type: 'integer',
        hasConflicts: false,
        typeRecord: {
          [fromNetworks[0]]: 'integer',
          [fromNetworks[1]]: 'integer',
          [fromNetworks[2]]: 'integer',
        },
        nameRecord: {
          [fromNetworks[0]]: 'att1',
          [fromNetworks[1]]: 'att1',
      ...
      },
      {
        ...
        hasConflicts: false,
        typeRecord: {
          [fromNetworks[0]]: 'string',
          [fromNetworks[1]]: 'string',
          [fromNetworks[2]]: 'string',
        },
        nameRecord: {
          [fromNetworks[0]]: 'name',
          [fromNetworks[1]]: 'name',
    ...
    const edgeAttributeMapping = createMatchingTable([
      ...
      },
      {
        ...
        nameRecord: {
          [fromNetworks[0]]: 'interaction',
          [fromNetworks[1]]: 'interaction',
          [fromNetworks[2]]: 'interaction',
        },
      },
      {
        id: 2,
