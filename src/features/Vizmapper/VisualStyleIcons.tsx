...
export function ContinuousMappingIcon(props: IconProps): React.ReactElement {
  return (
    <SvgIcon
      viewBox="0 0 40 40"
      sx={props.sx ?? defaultIconStyle.sx}
      style={props.style ?? defaultIconStyle.style}
    >
      <path d="M9.007,4 L14.993,4 C15.549,4 16,4.451 16,5.007 L16,10.993 C16,11.549 15.549,12 14.993,12 L9.007,12 C8.451,12 8,11.549 8,10.993 L8,5.007 C8,4.451 8.451,4 9.007,4 z" />
      <path d="M9.007,16 L14.993,16 C15.549,16 16,16.451 16,17.007 L16,22.993 C16,23.549 15.549,24 14.993,24 L9.007,24 C8.451,24 8,23.549 8,22.993 L8,17.007 C8,16.451 8.451,16 9.007,16 z" />
      <path d="M9.007,28 L14.993,28 C15.549,28 16,28.451 16,29.007 L16,34.993 C16,35.549 15.549,36 14.993,36 L9.007,36 C8.451,36 8,35.549 8,34.993 L8,29.007 C8,28.451 8.451,28 9.007,28 z" />
      <path d="M26,8 L30,8 L30,34 L26,34 L26,8 z" />
      <path d="M22.057,12 L28,2 L33.943,12 z" />
      <path d="M33.943,28 L28,38 L22.057,28 z" />
    </SvgIcon>
  )
}

export function DiscreteMappingIcon(props: IconProps): React.ReactElement {
  return (
    <SvgIcon
      viewBox="0 0 40 40"
      sx={props.sx ?? defaultIconStyle.sx}
    ...
    >
      ...
      <path d="M9.007,16 L14.993,16 C15.549,16 16,16.451 16,17.007 L16,22.993 C16,23.549 15.549,24 14.993,24 L9.007,24 C8.451,24 8,23.549 8,22.993 L8,17.007 C8,16.451 8.451,16 9.007,16 z" />
      <path d="M9.007,28 L14.993,28 C15.549,28 16,28.451 16,29.007 L16,34.993 C16,35.549 15.549,36 14.993,36 L9.007,36 C8.451,36 8,35.549 8,34.993 L8,29.007 C8,28.451 8.451,28 9.007,28 z" />
      <path d="M25.007,4 L30.993,4 C31.549,4 32,4.451 32,5.007 L32,10.993 C32,11.549 31.549,12 30.993,12 L25.007,12 C24.451,12 24,11.549 24,10.993 L24,5.007 C24,4.451 24.451,4 25.007,4 z" />
      <path d="M25.007,16 L30.993,16 C31.549,16 32,16.451 32,17.007 L32,22.993 C32,23.549 31.549,24 30.993,24 L25.007,24 C24.451,24 24,23.549 24,22.993 L24,17.007 C24,16.451 24.451,16 25.007,16 z" />
      <path d="M25.007,28 L30.993,28 C31.549,28 32,28.451 32,29.007 L32,34.993 C32,35.549 31.549,36 30.993,36 L25.007,36 C24.451,36 24,35.549 24,34.993 L24,29.007 C24,28.451 24.451,28 25.007,28 z" />
    </SvgIcon>
  )
}

export function PassthroughMappingIcon(props: IconProps): React.ReactElement {
  return (
    <SvgIcon
      viewBox="0 0 40 40"
      sx={props.sx ?? defaultIconStyle.sx}
    ...
    >
      ...
      <path d="M9.007,16 L14.993,16 C15.549,16 16,16.451 16,17.007 L16,22.993 C16,23.549 15.549,24 14.993,24 L9.007,24 C8.451,24 8,23.549 8,22.993 L8,17.007 C8,16.451 8.451,16 9.007,16 z" />
      <path d="M9.007,28 L14.993,28 C15.549,28 16,28.451 16,29.007 L16,34.993 C16,35.549 15.549,36 14.993,36 L9.007,36 C8.451,36 8,35.549 8,34.993 L8,29.007 C8,28.451 8.451,28 9.007,28 z" />
      <path d="M22.044,7.851 C22.531,7.899 22.935,8.117 23.293,8.44 L33.404,18.551 L33.511,18.669 C34.06,19.28 34.148,20.226 33.768,20.945 C33.633,21.202 33.57,21.256 33.404,21.44 L23.293,31.551 C22.495,32.349 21.201,32.349 20.404,31.551 C19.606,30.753 19.606,29.46 20.404,28.662 L29.07,19.995 L20.404,11.329 C19.606,10.531 19.606,9.238 20.404,8.44 C20.939,7.943 21.337,7.851 22.044,7.851 z" />
    </SvgIcon>
  )
}
