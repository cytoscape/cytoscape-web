import { deleteTask, submitTask } from './api'
import { JsonNode, Task } from './model'
...
//   while (true) {
//     const status: TaskStatus = await fetchTaskStatus(serviceUrl, taskId)
...
//   const taskResult: TaskResult = await fetchTaskResult(serviceUrl, taskId)
