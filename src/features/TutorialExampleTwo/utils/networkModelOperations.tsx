...
import { translateCXEdgeId, translateEdgeIdToCX } from '../../../models/NetworkModel/impl/CyNetwork'
...
export const addNodeToNetwork = async ({
  ...
  const { network, nodeTable, edgeTable, visualStyle,
    networkViews } = await getCachedData(networkId);
