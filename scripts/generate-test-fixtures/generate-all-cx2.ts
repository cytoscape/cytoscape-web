  ...
  const cx2Tasks: Cx2GenerationTask[] = [
    ...
    // CX2 Files with Network Attributes
    {
      ...
      output: join(
        CX2_OUTPUT_DIR,
        'valid',
        'with-network-attributes.valid.cx2',
      ),
    ...
    },
    {
      ...
      output: join(
        CX2_OUTPUT_DIR,
        'valid',
        'with-attribute-declarations.valid.cx2',
      ),
      category: 'Network Attributes',
    },
    ...
    },
    {
      ...
      output: join(
        CX2_OUTPUT_DIR,
        'valid',
        'with-multiple-opaque-aspects.valid.cx2',
      ),
      category: 'Opaque Aspects',
    },
    ...
    },
    {
      ...
      output: join(
        CX2_OUTPUT_DIR,
        'invalid',
        'invalid-aspect-structure.invalid.cx2',
      ),
      category: 'Invalid Structure',
    },
    {
    ...
    },
    {
      ...
      output: join(
        CX2_OUTPUT_DIR,
        'invalid',
        'invalid-edge-reference.invalid.cx2',
      ),
      category: 'Invalid Referential',
    },
  ...
  const hcxTasks: Cx2GenerationTask[] = [
    ...
    },
    {
      ...
      output: join(
        HCX_OUTPUT_DIR,
        'valid',
        'without-interaction-uuid.valid.cx2',
      ),
      category: 'Valid HCX',
    },
    {
    ...
    },
    {
      ...
      output: join(
        HCX_OUTPUT_DIR,
        'invalid',
        'invalid-schema-version.invalid.cx2',
      ),
      category: 'Invalid HCX',
    },
    {
      ...
      output: join(
        HCX_OUTPUT_DIR,
        'invalid',
        'invalid-filter-config.invalid.cx2',
      ),
      category: 'Invalid HCX',
    },
    {
